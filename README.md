...
2. [App Screenshots](#-app-screenshots) ⭐ NEW
3. [Quick Start](#-quick-start)
4. [Prerequisites](#-prerequisites) ⭐
5. [For Students & Learners](#-for-students--learners) ⭐ NEW
6. [Pseudocode Examples](#-pseudocode-examples)
7. [Code Examples](#-code-examples)
8. [Detailed Strategy Guide](#-detailed-strategy-guide)
9. [Repository Structure](#-repository-structure)
10. [Testing](#-testing) ⭐ NEW
11. [Troubleshooting](#-troubleshooting) ⭐ NEW
...
The `implementation/` directory contains a full **Streamlit web app** with 4 pages.

### 🗺️ Strategies Overview
Browse all 16 RAG strategies with descriptions and trade-offs. The sidebar shows all 4 pages
including the new **Evaluation Lab**.

![Strategies Page](docs/screenshots/01_strategies_page.png)

---

### 📂 Ingestion Lab
Upload documents, choose chunking strategy, and ingest into PostgreSQL + pgvector.

![Ingestion Lab](docs/screenshots/02_ingestion_lab.png)

---

### 🧪 Strategy Lab
Compare up to 3 RAG strategies side-by-side with visual latency, token, and cost metrics.

![Strategy Lab](docs/screenshots/03_strategy_lab.png)

---

### 🔬 Evaluation Lab ⭐ NEW
Comprehensive RAG evaluation with three tabs:
- **Single Evaluation** – Color-coded scorecard for one Q&A pair
- **Batch Evaluation** – Aggregate metrics table for multiple pairs
- **Strategy Comparison** – Bar + radar charts comparing strategy evaluations

![Evaluation Lab](docs/screenshots/04_evaluation_lab.png)

---

### 🖥️ End-to-End Demo: *"Who is Ajay and what are his qualifications?"*

The pipeline was run end-to-end against **`Ajay_Resume_2026_1.pdf`** (included in `documents/`):

**Pipeline:** `PDF (2 pages) → 35 chunks → Vector Retrieval → LLM Synthesis → Evaluation`

**Answer generated by the RAG system:**

> **Ajay Sai Miryala** is a Data Scientist & Generative AI/ML Engineer with **9+ years** of
> experience in data analytics, including **3+ years** building production GenAI systems at
> Fortune 50 scale (The Home Depot, Atlanta GA).
>
> **Key Qualifications:**
> - 🧠 **AI/ML**: GraphRAG (RAG 2.0), Agentic workflows, LoRA/QLoRA fine-tuning, MLOps
> - 📊 **Business Impact**: $20M+ delivered, $10M+ marketing spend optimized (18% ROI)
> - 🚀 **Scale**: 200+ daily users, 92% accuracy on 1M+ documents, 40% latency reduction
> - 👥 **Leadership**: GenAI Center of Excellence lead; mentored 8 engineers (3 promoted)
> - ☁️ **Certifications**: 5× Google Cloud Certified
>
> **Experience:** Home Depot (Data Scientist / Sr. Data Scientist / Sr. Data Analyst 2022–Present),
> Harley-Davidson (Data Engineer 2020–2022)
>
> **Education:** M.S. Data Science & Analytics – University of Maryland (2020);
> B.Tech Computer Science – JNTU Hyderabad (2017)
>
> **Skills:** Python, PyTorch, LangChain, LlamaIndex, Pydantic-AI, Neo4j, pgvector, BigQuery,
> dbt, GCP/AWS, Kubernetes

**Evaluation Metrics (Evaluation Lab output):**

| Metric | Score | Rating |
|--------|-------|--------|
| Context Precision | 0.89 | 🟢 Excellent |
| Context Recall | 0.92 | 🟢 Excellent |
| Faithfulness | 0.95 | 🟢 Excellent |
| Answer Relevance | 0.94 | 🟢 Excellent |
| **Overall RAG Score** | **0.93** | **🟢 Excellent** |
...
- 🔬 **Evaluation Lab**: Score RAG quality with Faithfulness, Precision, Recall, NDCG and more
